...
def test_modify_address(app):                                               # Тест изменения контакта
    ...
    address.id = old_addresses[index].id                                    # Установка идентификатора изменяемого элемента
    app.address.modify_address_by_index(index, address)                     # Изменение параметров контакта
    ...
    old_addresses[index] = address                                          # Изменение контакта в старом списке
